...
export const sendForgotPass = async (email, token) => {
  if (email && token) {
    ...
    const sendSmtpEmail = {
      ...
      subject: "Reset Your Password - Overnight AI",
      textContent: `Hi,\n\nWe received a request to reset your password for your Overnight AI account. Click the link below to reset it:\n\n${resetLink}\n\nIf you didn't request this, please ignore this email.\n\nBest regards,\nThe Overnight AI Team`,
      htmlContent: `
        <p>Hi,</p>
        <p>We received a request to reset your password for your <strong>Overnight AI</strong> account.</p>
